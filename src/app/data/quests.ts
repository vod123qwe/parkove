  ...
  },
  {
    ...
    pois: [
      ...
      },
      {
        ...
        photo: '/photos/skalki-sciany.jpg',
        photoCredit: 'Fot. MartinVeselka · CC BY-SA 4.0 · Wikimedia Commons',
    ...
    pois: [
      {
        id: 'start-dom',
        category: 'history',
        name: "Punkt startowy: Piltza 43",
        teaser: "Miejsce, z którego startuje wyprawa testowa.",
        description: [
          "To punkt kontrolny do testów: sprawdza, czy aplikacja poprawnie wykrywa Twoją pozycję jeszcze przed wyjściem z domu.",
          "Jeśli po starcie wyprawy ten punkt zalicza się sam, GPS i wykrywanie promienia działają. Jeśli nie, spróbuj wyjść na balkon albo przed budynek: w środku budynku sygnał bywa za słaby.",
          "Wyprawa testowa ma trzy punkty i pętlę o długości około pół kilometra, więc da się ją zrobić w dziesięć minut.",
        ],
        findHint: "Wejście do budynku przy ul. Piltza 43.",
        reveal: "GPS w telefonie jest dokładny na kilka metrów pod otwartym niebem, ale między blokami potrafi się mylić o kilkadziesiąt. Dlatego punkty w Parkove mają promienie od 25 do 80 metrów.",
      ...
      },
      {
        id: 'paczkomat',
        category: 'monument',
        name: "Paczkomat Allegro One Box",
        teaser: "Pierwszy punkt do zaliczenia, około 90 metrów od domu.",
        description: [
          "Punkt testowy numer dwa. Dojście zajmuje minutę, więc dobrze sprawdza, czy aplikacja wykrywa wejście w promień w trakcie chodzenia, a nie tylko po restarcie.",
          "Przy tym punkcie warto sprawdzić trzy rzeczy: czy telefon zawibrował, czy pojawił się ekran z historią i czy licznik punktów wyprawy podskoczył.",
          "Jeśli punkt zalicza się dopiero po odblokowaniu ekranu, to znaczy, że system uśpił aplikację: w PWA trzeba trzymać ekran włączony, i o tym właśnie mówi tryb wyprawy.",
        ],
        findHint: "Paczkomat Allegro One Box przy ul. Piltza, po zachodniej stronie.",
        reveal: "Tryb wyprawy w Parkove trzyma ekran włączony przez Wake Lock i nasłuchuje pozycji na żywo. To obejście ograniczenia przeglądarek: bez otwartej aplikacji telefon nie odda pozycji w tle.",
        coords: [19.88909, 50.01477],
        radius: 25,
      },
      {
        id: 'stokrotka',
        ...
        teaser: "Ostatni punkt wyprawy testowej, około 150 metrów od domu.",
        description: [
          "Punkt testowy numer trzy i zamknięcie pętli. Po jego zaliczeniu wyprawa powinna pokazać komplet: trzy z trzech punktów i złotą odznakę za sto procent.",
          "Sprawdź tu jeszcze dwie rzeczy: czy ślad wyprawy narysował się na mapie i czy licznik kilometrów pokazuje sensowną wartość. Powinno wyjść około pół kilometra na całej pętli.",
          "Po zakończeniu wyprawy zajrzyj do profilu: wyprawa powinna trafić do dziennika z datą, dystansem i czasem.",
        ],
        findHint: "Sklep Stokrotka Express przy ul. Piltza.",
        reveal: "Ślad wyprawy jest przed zapisem upraszczany algorytmem Douglasa-Peuckera: usuwa punkty, które nie zmieniają kształtu trasy. Dzięki temu godzinny spacer zajmuje w pamięci telefonu kilka kilobajtów.",
        coords: [19.88903, 50.01542],
        radius: 25,
      },
    ],
  },
